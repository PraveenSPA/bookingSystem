...
<%
    ...
    PreparedStatement ps = con.prepareStatement(
        "UPDATE Drivers SET driver_name=?,dob=?,joining_date=?,phone=?,email=?,address=?,license_number=?,license_type=?,license_expiry=?,emergency_contact_name=?,emergency_contact_phone=?,status=?,remarks=? WHERE driver_id=?"
    );
    ...
    ps.setString(13, request.getParameter("remarks"));
    ps.setInt(14, Integer.parseInt(request.getParameter("driver_id")));
    ps.executeUpdate();
    ps.close();
