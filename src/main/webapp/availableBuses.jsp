...
<%
    ...
    String redirectURL = request.getRequestURI() + "?" + request.getQueryString(); // save current page + params
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <script>
        function showLoginModal() {
            ...
            $('#loginModal input[name="redirect"]').val('<%= redirectURL %>'); // pass current page to login
        }
    </script>
</head>
